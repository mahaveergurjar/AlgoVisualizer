    ...
    <div className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <div className="p-4 max-w-7xl mx-auto">
        <header className="text-center mb-8 pt-6">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-green-400 to-teal-500 bg-clip-text text-transparent mb-3">
            {" "}
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3 w-full lg:w-auto">
              ...
              <input
                ...
                disabled={isLoaded}
                className="bg-gray-800 border border-gray-600 rounded-lg px-4 py-2.5 w-full focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition-all duration-300 disabled:opacity-50 font-mono text-sm"
            ...
            <div className="flex items-center gap-3">
              {!isLoaded ? (
                <button
                  ...
                  className="bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white font-bold py-2.5 px-8 rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105 cursor-pointer"
                >
                  {" "}
                  Load & Visualize{" "}
                </button>
                ...
                <>
                  <button
                    ...
                    className="bg-gray-700 hover:bg-gray-600 font-bold p-2.5 rounded-lg transition-all disabled:opacity-30"
                    title="Previous (←)"
                  >
                    {" "}
                    <svg
              ...
              <button
                ...
                className="ml-2 bg-red-600 cursor-pointer hover:bg-red-700 text-white font-bold py-2.5 px-6 rounded-lg shadow-lg transition-all transform hover:scale-105"
              >
                {" "}
                Reset{" "}
              </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-1 bg-gray-900/70 p-5 rounded-xl shadow-2xl border border-gray-700/50">
            <h3 className="font-bold text-xl text-teal-400 mb-4 border-b border-gray-700 pb-3 flex items-center gap-2">
              {" "}
                ...
                {Object.entries(codeContent).map(([lineNum, text]) => (
                  <div
                    ...
                    className={`flex items-start transition-all duration-300 ${
                      line === parseInt(lineNum) ? "bg-teal-500/20" : ""
                    }`}
                  >
          ...
          <div className="lg:col-span-2 space-y-6">
                  ...
                  <>
                    ...
                    <div className="absolute bottom-0 left-0 w-full h-full">
                      {arr.map((val, index) => {
                        ...
                        if (isInSearchSpace) dotColor = "bg-teal-500/50";
                        if (isMid) dotColor = "bg-blue-400";
                        if (isPeak) dotColor = "bg-green-400";
                        const range = maxValue - minValue;
                        const normalizedHeight =
                          range > 0 ? (val - minValue) / range : 1;
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`w-2.5 h-2.5 rounded-full ${dotColor} border-2 border-gray-950 transition-all duration-300 ${
                                isMid || isPeak ? "scale-150" : ""
                              }`}
                            ></div>
                            <div className="text-xs mt-2 text-gray-400 absolute left-1/2 -translate-x-1/2 top-full">
                              {val}
                            </div>
                            {isPeak && (
                              <StarIcon className="absolute -top-6 left-1/2 -translate-x-1/2 w-5 h-5 text-yellow-300 fill-current animate-pulse" />
                            )}
                          </div>
                        );
                      })}
            ...
            <div className="bg-gray-900/70 p-6 rounded-xl shadow-xl border border-gray-700/50 text-center">
              <h3 className="font-bold text-lg text-gray-300 mb-3">
                Algorithm State
              </h3>
              <p className="text-lg text-teal-300 h-6">
