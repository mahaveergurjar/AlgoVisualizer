      ...
      <div className="bg-gray-800 p-4 rounded-lg shadow-xl border border-gray-700 flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          {!isLoaded ? (
            <button
              onClick={loadArray}
              className="bg-green-500 hover:bg-green-600 text-gray-900 cursor-pointer font-bold py-2 px-4 rounded-lg"
            >
              Load & Visualize
            </button>
          ) : (
          ...
          <button
            onClick={reset}
            className="ml-4 bg-red-600 hover:bg-red-700 font-bold cursor-pointer py-2 px-4 rounded-lg"
          >
            Reset
          </button>
        </div>
