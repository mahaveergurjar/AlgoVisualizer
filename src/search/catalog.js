...
import {
  Container, Droplets, ToggleRight, ArrowUpDown, TrendingUp, Target, Calculator, Merge, Maximize2, Minus, Plus, MoveRight, BarChart3, RotateCcw,
  ArrowDownUp, GitMerge, Shuffle, Code2, Layers, Trees, ArrowRightLeft, ShoppingBasket,
  Grid, GaugeCircle, Mountain, Clock, Search, SearchCode, Share2, GitBranch, Route, Network,
  ArrowLeftRight, RefreshCw, Hash, CheckCircle2, Repeat, AlignLeft, Scissors, Text, Settings,
  Database, Infinity, Zap, Crown, Users, Circle,
  FlipHorizontal, Binary, BarChart4, List, Filter, MapPin, CheckCircle
} from "lucide-react";
...
export const problems = [
  ...
  {
    label: "Max Consecutive Ones III", // Also in SlidingWindows
    category: "Arrays",
  ...
  {
    label: "Sum of Subarray Ranges", // Also in Stack
    category: "Arrays",
  ...
  },
  {
    label: "4-Sum",
    category: "Arrays",
    subpage: "4-Sum", // Ensure filename matches
    keywords: ["array", "four sum", "4sum", "quadruplets", "two pointers", "18"],
    number: "18",
    icon: Layers,
    description: "Find all unique quadruplets in the array which give the sum of a target.",
    difficulty: "Medium",
    tier: "Tier 3",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  },
  {
    ...
    keywords: ["array", "product", "prefix", "suffix", "238", "except self", "division"],
    number: "238",
    icon: Calculator,
  ...
  },
  {
    ...
    keywords: ["array", "kadane", "maximum subarray", "53", "subarray sum", "dynamic programming"],
    number: "53",
    icon: TrendingUp,
  ...
  },
  {
    ...
    keywords: ["array", "split", "largest sum", "binary search", "greedy", "410"],
    number: "410",
    icon: BarChart3,
  ...
  {
    label: "Max Consecutive Ones III", // Also in Arrays
    category: "SlidingWindows",
    subpage: "MaxConsecutiveOnesIII",
    keywords: ["sliding window", "max", "consecutive", "ones", "flip", "1004", "array"],
    number: "1004",
    icon: ToggleRight,
  ...
  {
    label: "Minimum Window Substring", // Added by maintainer
    category: "SlidingWindows",
    subpage: "MinimumWindow",
    keywords: ["sliding window", "minimum", "window", "substring", "string", "hash map", "76"],
    number: "76",
    icon: Target,
  ...
  {
    label: "Longest Substring Without Repeating Characters", // Added by maintainer
    category: "SlidingWindows",
    subpage: "LongestSubstring",
    keywords: ["sliding window", "longest", "substring", "repeating", "unique", "string", "hash map", "3"],
    number: "3",
    icon: Hash,
  ...
  // =================================================================
  {
    ...
    keywords: ["linked list", "cycle", "loop", "floyd", "tortoise", "hare", "141"],
    number: "141",
    icon: Infinity,
  ...
  },
  {
    ...
    keywords: ["linked list", "merge", "sorted", "two pointers", "dummy node", "21"],
    number: "21",
    icon: GitMerge,
    description: "Merge two sorted linked lists and return as a single sorted list.",
    difficulty: "Easy",
    tier: "Tier 1",
    difficultyColor: "text-green-400",
    difficultyBg: "bg-green-400/10",
  ...
  {
    label: "Permutation", // Added by maintainer
    category: "Stack",
    subpage: "Permutation",
    keywords: ["stack", "permutation", "iterative", "backtracking", "46"],
    number: "46",
    icon: ArrowUpDown,
    description: "Generate all permutations of an array iteratively using an explicit stack.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  },
  {
    ...
    category: "Stack",
    subpage: "SubarrayRanges",
    keywords: ["stack", "subarray", "ranges", "sum", "monotonic", "2104", "array"],
    number: "2104",
    icon: ArrowUpDown,
  ...
  },
  {
    ...
    category: "Stack",
    subpage: "NextGreaterElement", // Ensure filename matches visualizer component
    keywords: ["stack", "next", "greater", "element", "monotonic", "circular", "496"],
    number: "496",
    icon: ArrowUpDown,
  ...
  // =================================================================
  {
    ...
    category: "Queue",
    subpage: "BasicQueue",
    keywords: ["queue", "fifo", "first-in-first-out", "enqueue", "dequeue", "linear"],
    number: "N/A",
    icon: ArrowRightLeft,
    description: "Elements are added at the rear and removed from the front, like a waiting line.",
    difficulty: "Easy",
    tier: "Tier 1",
    difficultyColor: "text-green-400",
    difficultyBg: "bg-green-400/10",
  ...
  },
  {
    ...
    category: "Queue",
    subpage: "QueueUsingStacks", // Ensure filename matches visualizer
  ...
  // =================================================================
  {
    ...
    number: "912",
    icon: ArrowDownUp,
    description: "A simple algorithm that repeatedly steps through the list, comparing and swapping adjacent elements.",
    difficulty: "Easy",
    tier: "Tier 1",
    difficultyColor: "text-green-400",
    difficultyBg: "bg-green-400/10",
  ...
  },
  {
    ...
    number: "N/A",
    icon: GitMerge,
    description: "An efficient, stable algorithm using the divide and conquer paradigm.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  },
  {
    ...
    number: "N/A",
    icon: Shuffle,
    description: "An efficient algorithm that uses partitioning to divide the array into smaller sub-arrays.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  },
  {
    ...
    number: "N/A",
    icon: Code2,
    description: "A simple algorithm that builds the final sorted array one element at a time.",
    difficulty: "Easy",
    tier: "Tier 1",
    difficultyColor: "text-green-400",
    difficultyBg: "bg-green-400/10",
  ...
  },
  {
    ...
    number: "N/A",
    icon: Layers,
    description: "A non-comparative algorithm that sorts numbers by processing individual digits.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  },
  {
    ...
    number: "N/A",
    icon: BarChart3,
    description: "A non-comparative algorithm that counts the frequency of each element to sort them.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  },
  {
    ...
    number: "N/A",
    icon: Trees,
    description: "A comparison-based technique based on a binary heap data structure.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  },
  {
    ...
    number: "N/A",
    icon: Target,
    description: "A simple algorithm that repeatedly selects the minimum element and moves it to the sorted part.",
    difficulty: "Easy",
    tier: "Tier 1",
    difficultyColor: "text-green-400",
    difficultyBg: "bg-green-400/10",
  ...
  // =================================================================
  {
    ...
    keywords: ["binary search", "2d matrix", "sorted matrix", "staircase search", "74"],
    number: "74",
    icon: Grid,
    description: "Efficiently find a target in a sorted m x n matrix.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  },
  {
    ...
    number: "1870",
    icon: GaugeCircle,
    description: "Find the minimum integer speed to travel across train routes within a given time limit.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
    ...
    tags: ["Optimization", "Monotonic"],
  },
  {
    label: "Peak Index in a Mountain Array",
    category: "BinarySearch",
    subpage: "PeakIndexInMountainArray",
    keywords: ["binary search", "peak", "mountain array", "852"],
    number: "852",
    icon: Mountain,
    description: "Find the index of the highest element in an array that first increases and then decreases.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
    ...
    tags: ["Peak Finding", "Logarithmic"],
  },
  {
    label: "Find First and Last Position",
    category: "BinarySearch",
    subpage: "FindFirstAndLastPosition",
    keywords: ["binary search", "first", "last", "position", "occurrence", "34"],
    number: "34",
    icon: Code2,
    description: "Given a sorted array, find the starting and ending position of a target value.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
    ...
    technique: "Binary Search",
    timeComplexity: "O(log n)",
    tags: ["Bounds", "Modified Search"],
  },
  {
    label: "Find Minimum in Rotated Sorted Array",
    category: "BinarySearch",
    subpage: "FindMinimumInRotatedSortedArray",
    keywords: ["binary search", "minimum", "rotated", "sorted", "pivot", "153"],
    number: "153",
    icon: Clock,
  ...
  },
  {
    ...
    keywords: ["binary search", "search", "rotated", "sorted", "pivot", "33"],
    number: "33",
    icon: Search,
    ...
    technique: "Binary Search",
    timeComplexity: "O(log n)",
    tags: ["Rotation", "Modified Search"],
  },
  {
    label: "Find Peak Element",
    category: "BinarySearch",
    subpage: "FindPeakElement",
    keywords: ["binary search", "peak", "neighbors", "162"],
    number: "162",
    icon: Mountain,
    description: "Find a peak element, which is an element strictly greater than its neighbors.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  },
  {
    ...
    number: "4",
    icon: Layers,
    description: "Find the median of two sorted arrays with O(log(min(m,n))) complexity.",
    difficulty: "Hard",
    tier: "Tier 3",
    difficultyColor: "text-red-400",
    difficultyBg: "bg-red-400/10",
    ...
    technique: "Binary Search",
    timeComplexity: "O(log(m+n))",
    tags: ["Hard", "Partitioning"],
  },
  {
    label: "Binary Search",
    category: "BinarySearch",
    subpage: "BinarySearchBasic",
    keywords: ["binary search", "search", "sorted", "fundamental", "basic", "704"],
    number: "704",
    icon: SearchCode,
    description: "The fundamental algorithm to find a target in a sorted array.",
    difficulty: "Easy",
    tier: "Tier 1",
    difficultyColor: "text-green-400",
    difficultyBg: "bg-green-400/10",
  ...
  // =================================================================
  {
    ...
    number: "1", // Made up number for ordering
    icon: ArrowLeftRight,
  ...
  },
  {
    ...
    number: "3", // Made up number for ordering
    icon: Hash,
  ...
  {
    label: "Longest Substring Without Repeating", // Also in SlidingWindows
    category: "Strings",
    subpage: "LongestSubstring",
    keywords: ["string", "longest", "substring", "repeating", "sliding window", "3"],
    number: "3",
    icon: Search,
    description: "Find length of longest substring without repeating characters.",
    difficulty: "Medium",
    tier: "Tier 3", // Or Tier 2 based on SlidingWindows
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
    difficultyBorder: "border-yellow-400/30",
    gradient: "from-emerald-500 to-teal-500",
  ...
  },
  {
    ...
    keywords: ["string", "longest", "palindromic", "substring", "expand around center", "5"],
    number: "5",
    icon: ArrowLeftRight,
  ...
  {
    label: "Minimum Window Substring", // Also in SlidingWindows
    category: "Strings",
    subpage: "MinWindowSubstring",
    keywords: ["string", "minimum", "window", "substring", "sliding window", "76"],
    number: "76",
    icon: Search,
    description: "Find minimum window containing all characters of a target string.",
    difficulty: "Hard",
    tier: "Tier 3",
    difficultyColor: "text-red-400",
    difficultyBg: "bg-red-400/10",
  ...
  // =================================================================
  {
    label: "Valid Anagram", // Duplicate from Strings, kept for category context
    category: "Hashing",
    subpage: "ValidAnagram",
    keywords: ["hashing", "anagram", "valid", "character counting", "242", "string"],
    number: "242",
    icon: Search, // Using Search icon from Hashing section
    description: "Check if two strings are anagrams using character counting.",
    difficulty: "Easy",
    tier: "Tier 2",
    difficultyColor: "text-green-400", // Using Hashing theme
    difficultyBg: "bg-green-400/10",
    difficultyBorder: "border-green-400/30",
  ...
  },
  {
    ...
    number: "560",
    icon: Database,
    description: "Count subarrays whose elements sum to k using prefix sums and hashing.",
    difficulty: "Medium",
    tier: "Tier 3",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  },
  {
    ...
    keywords: ["hashing", "longest", "consecutive", "sequence", "hash set", "128"],
    number: "128",
    icon: Hash,
    description: "Find the longest sequence of consecutive numbers using a set.",
    difficulty: "Medium",
    tier: "Tier 3",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  // =================================================================
  {
    ...
    keywords: ["tree", "construct", "build", "preorder", "inorder", "traversal", "105"],
    number: "105",
    icon: GitMerge,
  ...
  },
  {
    ...
    keywords: ["tree", "lca", "lowest common ancestor", "deepest leaves", "dfs", "1123"],
    number: "1123",
    icon: GitMerge,
    description: "Find the lowest common ancestor node of a binary tree's deepest leaves.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  {
    label: "Validate Binary Search Tree", // Added by maintainer
    category: "Trees",
    subpage: "ValidateBST",
  ...
  },
  {
    ...
    category: "Trees",
    subpage: "AVLTree",
    keywords: ["tree", "avl", "balanced", "binary search tree", "rotations", "110"],
    number: "110",
    icon: GitMerge,
  ...
  // =================================================================
  {
    ...
    category: "Design",
    subpage: "LRUCache",
    keywords: ["design", "lru", "cache", "least recently used", "hashmap", "doubly linked list", "146"],
    number: "146",
    icon: Settings,
  ...
  },
  {
    ...
    category: "Design",
    subpage: "LFUCache",
    keywords: ["design", "lfu", "cache", "least frequently used", "hashmap", "460"],
    number: "460",
    icon: Settings,
    description: "Implement an LFU (Least Frequently Used) cache that evicts the least frequently used key.",
    difficulty: "Hard",
    tier: "Tier 3",
    difficultyColor: "text-red-400",
    difficultyBg: "bg-red-400/10",
  ...
  },
  {
    ...
    number: "707",
    icon: Settings,
    description: "Design a Linked List that supports insert, delete, and get operations.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  // =================================================================
  {
    ...
    subpage: "RatInMaze",
    keywords: ["pathfinding", "maze", "rat", "backtracking", "bfs", "dfs", "graph traversal"],
    number: "N/A",
    icon: MapPin,
    description: "Find a path for a rat to reach from a source to a destination in a maze.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  { // ✅ Maintainer's new algorithm
    label: "Flood Fill",
    category: "Pathfinding",
    subpage: "FloodFill",
    keywords: ["pathfinding", "flood fill", "bucket tool", "bfs", "dfs", "graph traversal", "matrix"],
    number: "N/A", // Can add LeetCode #733 later
    icon: Zap, // Using Zap icon from HEAD
    description: "Fill an area with a color starting from a seed point. Implemented using BFS.",
    difficulty: "Easy",
    tier: "Tier 1",
    difficultyColor: "text-green-400",
    difficultyBg: "bg-green-400/10",
  ...
  { // ✅ Maintainer's new algorithm
    ...
    keywords: ["pathfinding", "color islands", "flood fill", "number of islands", "200"],
    number: "200",
    icon: Grid, // Using Grid icon from HEAD
    description: "Identify and color each island in a 2D grid with a unique color using Flood Fill.",
    difficulty: "Medium",
    tier: "Tier 2",
    difficultyColor: "text-yellow-400",
    difficultyBg: "bg-yellow-400/10",
  ...
  // Inside your export const problems = [ ... ] array in catalog.js
// Make sure all categories before Recursion are already correctly placed above this point.
...
// =================================================================
{
  ...
  keywords: ["recursion", "subset", "sum", "backtracking", "dynamic programming"],
  number: "25",
  icon: GitMerge,
...
},
{
  ...
  number: "26",
  icon: Container,
  description: "Move a stack of disks from one rod to another following specific rules.",
  difficulty: "Medium",
  tier: "Tier 2",
  difficultyColor: "text-yellow-400",
  difficultyBg: "bg-yellow-400/10",
...
},
{
  ...
  number: "27",
  icon: Zap,
  description: "Visualize the recursive call tree for the Fibonacci sequence.",
  difficulty: "Easy",
  tier: "Tier 1",
  difficultyColor: "text-green-400",
  difficultyBg: "bg-green-400/10",
...
},
{
  ...
  number: "28",
  icon: Hash,
  description: "Calculate factorial using recursion and visualize the linear call stack.",
  difficulty: "Easy",
  tier: "Tier 1",
  difficultyColor: "text-green-400",
  difficultyBg: "bg-green-400/10",
...
},
{
  ...
  keywords: ["recursion", "binary search", "divide and conquer", "sorted array"],
  number: "30",
  icon: Search,
...
// =================================================================
{
  ...
  keywords: ["bit manipulation", "xor", "single", "duplicate", "136"],
  number: "136",
  icon: Zap,
...
},
{
  ...
  category: "BitManipulation",
  subpage: "ReverseBits",
  keywords: ["bit manipulation", "reverse", "bits", "32-bit", "190"],
  number: "190",
  icon: FlipHorizontal,
...
},
{
  ...
  keywords: ["bit manipulation", "hamming weight", "count bits", "set bits", "191"],
  number: "191",
  icon: Hash,
  description: "Count the number of set bits (1's) in the binary representation of an integer.",
  difficulty: "Easy",
  tier: "Tier 1",
  difficultyColor: "text-green-400",
  difficultyBg: "bg-green-400/10",
...
},
{
  ...
  number: "231",
  icon: Zap,
  description: "Determine if an integer is a power of two using a clever bit trick.",
  difficulty: "Easy",
  tier: "Tier 1",
  difficultyColor: "text-green-400",
  difficultyBg: "bg-green-400/10",
...
},
{
  ...
  keywords: ["bit manipulation", "counting bits", "dp", "dynamic programming", "338"],
  number: "338",
  icon: Binary,
  description: "Return an array with the count of 1's for each number from 0 to n.",
  difficulty: "Easy",
  tier: "Tier 2",
  difficultyColor: "text-green-400",
  difficultyBg: "bg-green-400/10",
  ...
  timeComplexity: "O(n)",
  tags: ["Dynamic Programming", "Bitwise"],
},
...
// =================================================================
{
  label: "Build Heap (Heapify)",
  category: "Heaps",
  subpage: "Heapify",
  keywords: ["heap", "build", "heapify", "construction", "binary heap"],
  number: "101",
  icon: Layers,
...
},
{
  ...
  category: "Heaps",
  subpage: "TopKFrequent",
  keywords: ["heap", "top k", "frequent", "elements", "priority queue", "347"],
  number: "347",
  icon: Target,
...
},
{
  ...
  category: "Heaps",
  subpage: "PriorityQueue",
  keywords: ["heap", "priority queue", "operations", "insert", "extract"],
  number: "102",
  icon: Filter,
  description: "Implement a priority queue with insert and extract operations.",
  difficulty: "Medium",
  tier: "Tier 2",
  difficultyColor: "text-yellow-400",
  difficultyBg: "bg-yellow-400/10",
...
},
{
  ...
  category: "Heaps",
  subpage: "KthLargest",
  keywords: ["heap", "kth", "largest", "element", "quickselect", "partition", "215"],
  number: "215",
  icon: Hash,
...
// =================================================================
{
  ...
  category: "Graphs",
  subpage: "BFS",
  keywords: ["graph", "bfs", "breadth-first", "shortest path", "traversal", "queue"],
  number: "N/A",
  icon: Share2,
  description: "Explore nodes level by level, finding the shortest path in unweighted graphs.",
  difficulty: "Easy",
  tier: "Tier 1",
  difficultyColor: "text-green-400",
  difficultyBg: "bg-green-400/10",
  ...
  tags: ["Traversal", "Fundamental"],
},
{
  label: "Depth-First Search (DFS)",
  category: "Graphs",
  subpage: "DFS",
  keywords: ["graph", "dfs", "depth-first", "traversal", "stack", "recursion"],
  number: "N/A",
  icon: GitBranch,
...
},
{
  ...
  category: "Graphs",
  subpage: "Dijkstra",
  keywords: ["graph", "dijkstra", "shortest path", "weighted", "priority queue"],
  number: "N/A",
  icon: Route,
  description: "Find the shortest path from a source to all other vertices in a weighted graph.",
  difficulty: "Medium",
  tier: "Tier 2",
  difficultyColor: "text-yellow-400",
  difficultyBg: "bg-yellow-400/10",
  ...
  tags: ["Shortest Path", "Classic"],
},
{
  label: "Kruskal's Algorithm",
  category: "Graphs",
  subpage: "Kruskal",
  keywords: ["graph", "kruskal", "minimum spanning tree", "mst", "union-find", "greedy"],
  number: "N/A",
  icon: GitMerge,
  description: "Find the Minimum Spanning Tree by greedily selecting edges with minimum weight.",
  difficulty: "Medium",
  tier: "Tier 2",
  difficultyColor: "text-yellow-400",
  difficultyBg: "bg-yellow-400/10",
...
},
{
  ...
  category: "Graphs",
  subpage: "TopologicalSort",
  keywords: ["graph", "topological", "sort", "dag", "directed acyclic", "dependencies", "207"],
  number: "207",
  icon: Network,
...
// =================================================================
{
  ...
  number: "122",
  icon: TrendingUp,
  description: "Maximize profit by buying and selling stocks multiple times with a greedy approach.",
  difficulty: "Medium",
  tier: "Tier 2",
  difficultyColor: "text-yellow-400",
  difficultyBg: "bg-yellow-400/10",
...
},
{
  ...
  keywords: ["greedy", "two city", "scheduling", "cost", "optimization", "1029"],
  number: "1029",
  icon: Users,
  description: "Schedule interviews for two cities, minimizing the total cost using greedy selection.",
  difficulty: "Medium",
  tier: "Tier 2",
  difficultyColor: "text-yellow-400",
  difficultyBg: "bg-yellow-400/10",
...
},
{
  ...
  number: "45",
  icon: Target,
  description: "Find the minimum number of jumps to reach the end of an array using a greedy BFS approach.",
  difficulty: "Medium",
  tier: "Tier 2",
  difficultyColor: "text-yellow-400",
  difficultyBg: "bg-yellow-400/10",
...
},
{
  ...
  number: "134",
  icon: Circle,
  description: "Find the starting gas station to complete a circular route using a greedy check.",
  difficulty: "Medium",
  tier: "Tier 2",
  difficultyColor: "text-yellow-400",
  difficultyBg: "bg-yellow-400/10",
...
// =================================================================
{
  ...
  subpage: "KnapSack", // Corrected subpage name
  keywords: ["dp", "dynamic programming", "knapsack", "0/1", "partition", "subset sum", "416"],
  number: "416",
  icon: TrendingUp,
  description: "Determine the maximum value that can be put in a knapsack of capacity W.",
  difficulty: "Medium",
  tier: "Tier 3",
  difficultyColor: "text-yellow-400",
  difficultyBg: "bg-yellow-400/10",
...
// Ensure all other detailed categories are above this final closing bracket
];