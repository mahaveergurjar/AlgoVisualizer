...
export const problems = [
  ...
  {
label: "Linear Search",
category: "LinearSearch",
subpage: "LinearSearch",
keywords: ["linear search", "sequential scan", "beginner", "101"],
number: "101",
icon: ScanSearch,
...
category: "ExponentialSearch",
subpage: "ExponentialSearch",
keywords: ["exponential search", "range finding", "binary search", "102"],
number: "102",
icon: Zap,
...
category: "LinearSearch",
subpage: "FindSmallestLetterGreaterThanTarget",
keywords: ["linear scan", "lexicographical", "744"],
number: "744",
icon: Search,
...
tags: ["Character Array", "Lexicographical", "Linear Scan"],
},
{
label: "Search in Sorted Array of Unknown Size",
category: "ExponentialSearch",
subpage: "SearchInSortedArrayOfUnknownSize",
keywords: ["exponential search", "unknown size", "702"],
number: "702",
icon: Send,
...
category: "LinearSearch",
subpage: "KthMissingPositiveNumber",
keywords: ["linear scan", "missing numbers", "1539"],
number: "1539",
icon: Filter,
...
{
label: "Special Array With X Elements",
category: "LinearSearch",
subpage: "SpecialArrayWithXElements",
keywords: ["linear search", "special array", "1608"],
number: "1608",
icon: Grid,
...
tags: ["Special Array", "Linear Check", "Counting"],
  ...
  },
  {
    ...
    icon: GitMerge,
    description:
      "Visualize BFS-based augmenting paths, residual capacities, and bottleneck updates.",
    difficulty: "Hard",
    tier: "Tier 2",
    difficultyColor: "text-red-400",
    difficultyBg: "bg-red-400/10",
    ...
    technique: "BFS-based Ford–Fulkerson",
    timeComplexity: "O(V·E²)",
    tags: ["Residual Graph", "Augmenting Path", "Bottleneck"],
  },
];
